...
Kotest의 DCI 스타일은 입력 조건과 기대 결과를 계층적으로 표현하기 좋아 Controller나 Repository 테스트에 특히 잘 맞습니다. 반면 비즈니스 규칙을 중심으로 설명해야 하는 Service 계층은 BDD가 더 읽기 쉬운 경우가 많으므로, 계층 성격에 따라 스타일을 나눠 쓰는 편이 효과적입니다.
